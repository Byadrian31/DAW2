...
export default function Header({carrito, eliminarDelCarrito, menosCantidad, masCantidad, limpiarCarrito}) {
            ...
            <nav className="col-md-6 a mt-5 d-flex align-items-start justify-content-end">
              ...
              >
                ...
                <div id="carrito" className="bg-white p-3">
                      ...
                      <tr key={element.id}>
                        ...
                        <td className="flex align-items-start gap-4">
                          <button
                            ...
                            onClick={() => menosCantidad(element.id)}
                          >
                            -
                          </button>
                          {element.cantidad}
                          <button
                            type="button"
                            className="btn btn-dark"
                            onClick={() => masCantidad(element.id)}
                          >
                            +
                          </button>
                        </td>
                  ...
                  <button className="btn btn-dark w-100 mt-3 p-2" onClick = {limpiarCarrito}>Vaciar Carrito</button>
                </div>
              </div>
            </nav>
          </div>
